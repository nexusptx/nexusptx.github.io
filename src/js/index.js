...
credits.addEventListener('click', function() {
  ...
  intro.classList.add('hide');
  setTimeout(function() {
    intro.innerHTML = "The gallery layout has been fine tuned by me, still <span id='colored-side'>80%</a> left to fine tune. The rest of this website is made by <a href='https://discord.com/users/714821119080923177' id='hyper'>Nexus</a></span>, see the code on <span id='colored-side'><a href='https://github.com/nexusptx/nexusptx.github.io' id='hyper'>Github</a></span>.";
    intro.classList.remove('hide');
  }, 1000);z
});
